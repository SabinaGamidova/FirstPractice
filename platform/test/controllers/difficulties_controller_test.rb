...
class DifficultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create difficulty" do
    assert_difference("Difficulty.count") do
      post difficulties_url, params: { difficulty: { difficulty_id: @difficulty.difficulty_id, title: @difficulty.title } }
    end
  ...
  test "should update difficulty" do
    patch difficulty_url(@difficulty), params: { difficulty: { difficulty_id: @difficulty.difficulty_id, title: @difficulty.title } }
