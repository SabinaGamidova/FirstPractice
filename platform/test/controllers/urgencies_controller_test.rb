...
class UrgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create urgency" do
    assert_difference("Urgency.count") do
      post urgencies_url, params: { urgency: { title: @urgency.title, urgency_id: @urgency.urgency_id } }
    end
  ...
  test "should update urgency" do
    patch urgency_url(@urgency), params: { urgency: { title: @urgency.title, urgency_id: @urgency.urgency_id } }
