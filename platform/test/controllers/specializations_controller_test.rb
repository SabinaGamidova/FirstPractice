...
class SpecializationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialization" do
    assert_difference("Specialization.count") do
      post specializations_url, params: { specialization: { specialization_id: @specialization.specialization_id, title: @specialization.title } }
    end
  ...
  test "should update specialization" do
    patch specialization_url(@specialization), params: { specialization: { specialization_id: @specialization.specialization_id, title: @specialization.title } }
