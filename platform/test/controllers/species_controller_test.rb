...
class SpeciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create species" do
    assert_difference("Species.count") do
      post species_index_url, params: { species: { species_id: @species.species_id, title: @species.title, type: @species.type } }
    end
  ...
  test "should update species" do
    patch species_url(@species), params: { species: { species_id: @species.species_id, title: @species.title, type: @species.type } }
