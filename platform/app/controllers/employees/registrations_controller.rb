...
class Employees::RegistrationsController < Devise::RegistrationsController
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.permit(:sign_up) do |user_params|
      user_params.permit(:email, :password, :password_confirmation, employee_profile_attributes: [:first_name, :last_name, :phone, :date_registration, :specialization_id])
    end
  ...
  def sign_up_params
    params.require(:employee).permit(:email, :password, :password_confirmation, 
                                     employee_profile_attributes: [:first_name, :last_name, :phone, :date_registration, :specialization_id])
         .tap do |whitelisted|
